<template>
  <div class="flex flex-col items-center mt-6 border-2 p-3 rounded-md">
    <div
    ...
    >
      ...
      <p
        class="block text-center mt-1 font-sans text-base antialiased font-normal leading-relaxed text-gray-700"
      >
        Enter the Product details to add to the Admin page.
      </p>
      <form
...
export default {
  ...
  methods: {
    submitData() {
      ...
      const qty = "1";
      const enteredTotalPrice = this.$refs.totalPriceInput.value;

      this.addProducts(enteredName, enteredPrice, enteredUrl, qty, enteredTotalPrice);
    },
  },
};
</script>